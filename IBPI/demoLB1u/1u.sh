...
output_dir=$model_base_dir"demo/model3"
CUDA_VISIBLE_DEVICES="6" /hpf/anaconda3/envs/tf2/bin/python AliceMind_main/LatticeBERT/run_sequence_labeling_crf_labert.py \
